...
namespace Raytracer::Engine {
    ...
    Color lighting(const Material& material, const Shape* object, const Light& light, const Point& point, const Vector& eyev, const Vector& normalv, bool in_shadow = false, const LightingModel& lightingModel = LightingModel::Phong);
